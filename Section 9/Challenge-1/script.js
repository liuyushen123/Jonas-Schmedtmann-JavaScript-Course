...
Suppose we get data from a web service about a certain game ('game' variable below).
...
6. Write a function ('printGoals') that receives an arbitrary number of player names
   (NOT an array) and prints each of them to the console, along with the number
